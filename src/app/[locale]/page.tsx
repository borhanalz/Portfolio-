...
import CooperationModal from "Components/CooperationModal/CooperationModal";
      ...
      <div className="flex justify-around mt-10">
        <div className="mt-5 mb-20 text-center space-y-10">
          <Image
            src={myImage}
            alt="BorhanAlizdeh"
            className="w-36 sm:w-64 md:w-52 inline-block rounded-full"
          />
          <Defination />
          <div className="space-x-5 mt-20">
          <Link href="?modal=true"><button className="bg-transparent border p-5 rounded-3xl">
              Start Cooperation
            </button></Link>
            <button className="bg-transparent border p-5 rounded-3xl">
              View All Works
            </button>
          </div>
        </div>
